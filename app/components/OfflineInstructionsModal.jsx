...
const OfflineInstructionsModal = () => {
  ...
  return (
    <>
      {isOpen ? (
        <div className="fixed top-0 left-0 h-screen w-full flex justify-center items-center bg-cover">
          <div className="bg-[#75BDE9] p-5 rounded-xl max-w-4xl mx-4 mt-32 mb-10 shadow-lg">
            <div className="p-4 bg-transparent border-dashed border-2 border-neutral-800 rounded-xl flex flex-col h-[75vh] relative">
              ...
              <ol className="list-decimal body-font font-semibold pl-8 overflow-y-scroll scrollbar-none">
                ...
                <li>
                  Enter the 5-digit code associated with the entry (displayed on
                  the entry itself) that you want to add to your wishlist and
              ...
              <button
                className=" text-black rounded-full absolute sm:right-4 sm:top-4 right-2 top-2"
                onClick={handleClose}
              >
...
export default OfflineInstructionsModal;
