...
const Voting = () => {
  return (
    <div className="min-h-screen relative">
      ...
      <main className="relative z-10 pt-32 flex items-center justify-center min-h-screen text-center px-6">
        <div>
          <h1
            className={`${rye.className} text-[#FFA53A] text-3xl sm:text-4xl md:text-5xl tracking-widest uppercase drop-shadow-lg`}
          >
